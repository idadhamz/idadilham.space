              ...
              <section class="text-gray-600 body-font">
                <div class="container mx-auto flex flex-wrap">
                  ...
                  { listWork.map((data, index) => (
                      ...
                      <div class="flex relative pt-5 pb-5 sm:items-center md:w-2/3" key={index}>
                        <div class="flex-shrink-0 w-12 h-12 rounded-full mt-auto sm:mt-0 inline-flex items-center justify-center bg-green-500 text-white relative z-10 title-font font-medium text-lg">{index+1}</div>
                        <div class="flex-grow md:pl-2 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                          <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                            <h1 class="font-bold title-font text-black mb-1 text-xl pr-5">{data.job}</h1>
                            <p><span class="font-semibold text-green-700 hover:underline"><a href={data.url}> {data.company}</a></span> ({data.date})</p>
                          </div>
                        </div>
                      </div>
