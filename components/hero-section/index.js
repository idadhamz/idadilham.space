    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-4">
            <div className="col-span-1">
                <img src="/assets/img/fotoDadi.jfif" alt="fotoHero" className="object-cover h-auto w-60 lg:w-80 rounded-xl" />
            </div>
            <div className="col-span-3 lg:my-auto">
                <div className="my-10 lg:my-auto lg:mx-20">
                    ...
                    <p className="leading-relaxed text-gray-700 text-md">Hello my name is <b>Dadi ilham
                        ...
                        Let's get acquainted with me through <span className="font-bold text-blue-700 transition duration-300 hover:underline"><Link href="https://www.linkedin.com/in/idadilhams/"> LinkedIn</Link></span> or <span className="font-bold text-purple-700 transition duration-300 hover:underline"><Link href="https://www.instagram.com/idadcode/">Instagram</Link></span>
                    </p>
                </div>
            </div>
        </div>
